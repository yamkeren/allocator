...
from allocator_manager.api.v1 import devices, groups, nodes, sessions
...
internal_router.include_router(
    node_agent.router, prefix="/nodes", tags=["internal-nodes"]
)
internal_router.include_router(
    heartbeat.router, prefix="/nodes", tags=["internal-heartbeat"]
)
